 ...
 */
@Component
public class ResponseForPersonContactAdd extends ResponseGeneratorImpl {

	private static final Logger logger = LoggerFactory.getLogger(ResponseForPersonContactAdd.class);
	/*
	 * (non-Javadoc)
	 * 
